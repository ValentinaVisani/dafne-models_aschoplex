...
class Ui_ModelTrainerUI(object):
    def setupUi(self, ModelTrainerUI):
        ...
        self.label_3 = QtWidgets.QLabel(ModelTrainerUI)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_3.addWidget(self.label_3)
        self.levels_spin = QtWidgets.QSpinBox(ModelTrainerUI)
        self.levels_spin.setMinimum(1)
        self.levels_spin.setProperty("value", 5)
        self.levels_spin.setObjectName("levels_spin")
        self.horizontalLayout_3.addWidget(self.levels_spin)
        self.label_4 = QtWidgets.QLabel(ModelTrainerUI)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_3.addWidget(self.label_4)
        self.convlayers_spin = QtWidgets.QSpinBox(ModelTrainerUI)
        self.convlayers_spin.setProperty("value", 2)
        self.convlayers_spin.setObjectName("convlayers_spin")
        self.horizontalLayout_3.addWidget(self.convlayers_spin)
        self.label_5 = QtWidgets.QLabel(ModelTrainerUI)
        self.label_5.setObjectName("label_5")
        self.horizontalLayout_3.addWidget(self.label_5)
        self.kernsize_spin = QtWidgets.QSpinBox(ModelTrainerUI)
        self.kernsize_spin.setMinimum(1)
        self.kernsize_spin.setProperty("value", 2)
        self.kernsize_spin.setObjectName("kernsize_spin")
        self.horizontalLayout_3.addWidget(self.kernsize_spin)
